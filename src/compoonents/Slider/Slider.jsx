  ...
  return (
    ...
    >
      <SwiperSlide className="flex items-center justify-normal  my-auto">
        <div className="max-h-[40vh] md:max-h-[60vh] md:p-10 md:flex items-center justify-center ">
          <div className=" z-20 md:w-1/2 p-4">
            <p>Who we are</p>
            <h2 className="md:text-4xl text-xl font-bold md:mb-4 mb-2">
              Our Job is to Empower the World
            </h2>
            <p className="text-lg mb-4">
              Through the development of technology through combined knowledge.
            </p>
          ...
          <div className="md:w-1/2 mx-auto flex items-end">
            <img
              src={celebrat}
              alt="Image of two students celebrating"
              className=" m-auto"
            />
          </div>
        </div>
        ...
        >
          ...
          <div className="relative text-center z-10 px-4">
            ...
            <p className="text-lg md:text-xl mb-6">
              A platform to ask questions, share insights, and find solutions
              together.
            </p>
            <Link
              to={"/add-queries"}
      ...
      <SwiperSlide className="flex items-center justify-center">
        <div className=" min-h-[40vh] md:min-h-[60vh] bg-cover bg-center text-white flex items-center justify-center backgroundImage1  relative">
