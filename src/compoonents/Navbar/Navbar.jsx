  ...
  const handlLogout = () => {
    logoutUser()
      .then(() => {
        axios
          .post(
            "https://b10a11-server-side-abdullah107189.vercel.app/jwt-logout",
            user,
    ...
    <div className="mxw text-white bgP ">
      <div className="navbar py-0">
        <div className="navbar-start z-30 ">
            ...
            {user ? (
              ...
              >
                <NavLink
                  to="/"
                  className={({ isActive }) =>
                    `${isActive ? "activeActionBtn" : "actionBtn"}   `
                  }
                >
                  Home
                </NavLink>
          ...
          <a href="/">
            <img
              className="w-14 h-14 object-contain dark:bg-gray-400 rounded-lg"
              src={logo}
              alt=""
            />
          </a>
          ...
          {user ? (
            <div className="flex gap-2 items-center">
              <img
                ...
                alt=""
              />
              <button onClick={handlLogout} className="actionBtn w-full">
                Log-out
              </button>
            </div>
          ) : (
            <div>
              <NavLink
                to="/login"
                className={({ isActive }) =>
                  `${isActive ? "activeActionBtn" : "actionBtn"} mr-3   `
                }
              >
                Login
              </NavLink>
